...
/**
 * Test class for {@link WatchFilePropertiesImplStub}.
 * 
 * @author Alan Buttars
 *
 */
public class WatchFilePropertiesImplStubTest {
	...
	public void setup() throws IOException {
		this.file = WatchTestHelper.getSourceFile("user-properties");
		this.eventBus = mock(EventBus.class);
	}

	@Test
	public void testWithEventBus() throws IOException {
		ConfigurationPropertiesImpl config = new WatchFilePropertiesImplStub(file).withEventBus(eventBus);
	...
	public void testWithNullEventBus() throws IOException {
		try {
			new WatchFilePropertiesImplStub(file).withEventBus(null);
		}

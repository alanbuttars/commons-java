...
/**
 * Terminal stub used to create a {@link ConfigurationYamlImpl} from a YAML file which represents some object.
 * 
 * @author Alan Buttars
 *
 * @param <T>
 *            Type belonging to {@link ConfigurationYamlImpl}
 */
public class WatchFileYamlClassImplStub<T> {

	protected final File file;
	protected final Class<T> clazz;

	WatchFileYamlClassImplStub(File file, Class<T> clazz) {
		this.file = file;
		this.clazz = clazz;
	}

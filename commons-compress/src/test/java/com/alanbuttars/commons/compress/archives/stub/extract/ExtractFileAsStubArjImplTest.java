...
/**
 * Test class for {@link ExtractFileAsStubArjImpl}
 * 
 * @author Alan Buttars
 *
 */
public class ExtractFileAsStubArjImplTest {

	private File archive;
	private ExtractFileAsStubArjImpl stub;

	@Before
	public void setup() throws IOException {
		archive = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ExtractFileAsStubArjImpl(archive));
	}

...
/**
 * Test class for {@link DecompressFileWithStub}.
 * 
 * @author Alan Buttars
 *
 */
public class DecompressFileWithStubTest {

	private File source;
	private File destination;
	private DecompressFileWithStub stub;

	@Before
	public void setup() throws IOException {
		source = File.createTempFile(getClass().getName(), ".tmp");
		destination = File.createTempFile(getClass().getName(), ".tmp");
		stub = new DecompressFileWithStub(source, "blah") {

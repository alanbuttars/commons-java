...
/**
 * Test class for {@link DecompressArchiveWithStubDumpImpl}.
 * 
 * @author Alan Buttars
 *
 */
...
public class DecompressArchiveWithStubDumpImplTest {

	private File source;
	private File destination;
	private DecompressArchiveWithStubDumpImpl stub;
	...
	public void testConstructor() {
		...
		assertEquals(DUMP, stub.fileType);
	}

	@Test(expected = RuntimeException.class)
	public void testDecompressionFunction() throws ArchiveException, IOException {
		stub.to(destination);
		verify(stub, times(1)).createArchiveInputStream(eq(source), eq("UTF8"));
	}

...
/**
 * Test class for {@link DecompressArchiveWithStub7zImpl}.
 * 
 * @author Alan Buttars
 *
 */
...
public class DecompressArchiveWithStub7zImplTest {

	private File source;
	private File destination;
	private DecompressArchiveWithStub7zImpl stub;

	@Before
	public void setup() throws IOException {
		source = File.createTempFile(getClass().getName(), ".tmp");
		destination = Files.createTempDirectory(getClass().getName()).toFile();
		stub = spy(new DecompressArchiveWithStub7zImpl(source));
	}

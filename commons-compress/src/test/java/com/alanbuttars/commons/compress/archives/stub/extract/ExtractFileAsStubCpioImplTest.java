...
/**
 * Test class for {@link ExtractFileAsStubCpioImpl}
 * 
 * @author Alan Buttars
 *
 */
public class ExtractFileAsStubCpioImplTest {

	private File archive;
	private ExtractFileAsStubCpioImpl stub;

	@Before
	public void setup() throws IOException {
		archive = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ExtractFileAsStubCpioImpl(archive));
	}

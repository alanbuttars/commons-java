...
/**
 * Test class for {@link ExtractFileWithStubZipImpl}
 * 
 * @author Alan Buttars
 *
 */
public class ExtractFileWithStubZipImplTest {

	private File archive;
	private ExtractFileWithStubZipImpl stub;

	@Before
	public void setup() throws IOException {
		archive = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ExtractFileWithStubZipImpl(archive));
	}

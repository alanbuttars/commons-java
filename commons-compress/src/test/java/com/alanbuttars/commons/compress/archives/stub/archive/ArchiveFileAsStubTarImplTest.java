...
/**
 * Test class for {@link ArchiveFileAsStubTarImpl}.
 * 
 * @author Alan Buttars
 *
 */
public class ArchiveFileAsStubTarImplTest {

	private File directory;
	private File destination;
	private ArchiveFileAsStubTarImpl stub;

	@Before
	public void setup() throws IOException {
		directory = Files.createTempDirectory(getClass().getName()).toFile();
		destination = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ArchiveFileAsStubTarImpl(directory));
	}

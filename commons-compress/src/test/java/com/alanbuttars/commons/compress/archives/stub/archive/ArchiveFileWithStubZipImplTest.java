...
/**
 * Test class for {@link ArchiveFileWithStubZipImpl}.
 * 
 * @author Alan Buttars
 *
 */
public class ArchiveFileWithStubZipImplTest {

	private File directory;
	private File destination;
	private ArchiveFileWithStubZipImpl stub;

	@Before
	public void setup() throws IOException {
		directory = Files.createTempDirectory(getClass().getName()).toFile();
		destination = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ArchiveFileWithStubZipImpl(directory));
	}

...
/**
 * Test class for {@link ExtractFileAsStubDumpImpl}
 * 
 * @author Alan Buttars
 *
 */
public class ExtractFileAsStubDumpImplTest {

	private File archive;
	private ExtractFileAsStubDumpImpl stub;

	@Before
	public void setup() throws IOException {
		archive = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ExtractFileAsStubDumpImpl(archive));
	}

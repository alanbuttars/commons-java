...
/**
 * Test class for {@link ExtractFileWithStubTarImpl}
 * 
 * @author Alan Buttars
 *
 */
public class ExtractFileWithStubTarImplTest {

	private File archive;
	private ExtractFileWithStubTarImpl stub;

	@Before
	public void setup() throws IOException {
		archive = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ExtractFileWithStubTarImpl(archive));
	}

...
/**
 * Test class for {@link CompressFileWithStub}.
 * 
 * @author Alan Buttars
 *
 */
public class CompressFileWithStubTest {

	private File source;
	private File destination;
	private CompressFileWithStub stub;

	@Before
	public void setup() throws IOException {
		source = File.createTempFile(getClass().getName(), ".tmp");
		destination = File.createTempFile(getClass().getName(), ".tmp");
		stub = new CompressFileWithStub(source, "blah") {

...
/**
 * Test class for {@link ExtractFileAsStubArImpl}
 * 
 * @author Alan Buttars
 *
 */
public class ExtractFileAsStubArImplTest {

	private File archive;
	private ExtractFileAsStubArImpl stub;

	@Before
	public void setup() throws IOException {
		archive = File.createTempFile(getClass().getName(), ".tmp");
		stub = new ExtractFileAsStubArImpl(archive);
	}

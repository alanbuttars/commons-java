...
/**
 * Test class for {@link ExtractFileWithStubJarImpl}
 * 
 * @author Alan Buttars
 *
 */
public class ExtractFileWithStubJarImplTest {

	private File archive;
	private ExtractFileWithStubJarImpl stub;

	@Before
	public void setup() throws IOException {
		archive = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ExtractFileWithStubJarImpl(archive));
	}

...
/**
 * Test class for {@link DecompressFileWithStubBzipImpl}.
 * 
 * @author Alan Buttars
 *
 */
...
public class DecompressFileWithStubBzipImplTest {

	private File source;
	private File destination;
	private DecompressFileWithStubBzipImpl stub;

	@Before
	public void setup() throws IOException {
		source = File.createTempFile(getClass().getName(), ".tmp");
		destination = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new DecompressFileWithStubBzipImpl(source));
	}

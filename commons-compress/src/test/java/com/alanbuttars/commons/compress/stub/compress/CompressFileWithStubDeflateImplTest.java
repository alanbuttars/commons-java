...
/**
 * Test class for {@link CompressFileWithStubDeflateImpl}.
 * 
 * @author Alan Buttars
 *
 */
public class CompressFileWithStubDeflateImplTest {

	private File source;
	private File destination;
	private CompressFileWithStubDeflateImpl stub;
	...
	public void testCompressionFunction() throws IOException {
		stub.to(destination);
		verify(stub, times(1)).createCompressedFileOutputStream(any(OutputStream.class), isNotNull(DeflateParameters.class));
	}

...
/**
 * Test class for {@link CompressDirectoryWithStubZipImpl}.
 * 
 * @author Alan Buttars
 *
 */
public class CompressDirectoryWithStubZipImplTest {

	private File source;
	private File destination;
	private CompressDirectoryWithStubZipImpl stub;
	...
	public void testEntryFunction() {
		...
		assertEquals(-1, zipEntry.getSize());
	}
}

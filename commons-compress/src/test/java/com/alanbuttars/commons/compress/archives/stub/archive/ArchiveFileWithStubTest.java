...
/**
 * Test class for {@link ArchiveFileWithStub}.
 * 
 * @author Alan Buttars
 *
 */
public class ArchiveFileWithStubTest {

	private File directory;
	private ArchiveFileWithStub stub;

	@Before
	public void setup() throws IOException {
		directory = Files.createTempDirectory(getClass().getName()).toFile();
		stub = new ArchiveFileWithStub(directory, "blah") {

...
/**
 * Test class for {@link ArchiveFileWithStubSevenZImpl}.
 * 
 * @author Alan Buttars
 *
 */
public class ArchiveFileWithStubSevenZImplTest {

	private File directory;
	private File destination;
	private ArchiveFileWithStubSevenZImpl stub;

	@Before
	public void setup() throws IOException {
		directory = Files.createTempDirectory(getClass().getName()).toFile();
		destination = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ArchiveFileWithStubSevenZImpl(directory));
	}

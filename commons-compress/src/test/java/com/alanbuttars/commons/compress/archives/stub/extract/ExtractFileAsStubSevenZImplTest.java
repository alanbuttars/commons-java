...
/**
 * Test class for {@link ExtractFileAsStubSevenZImpl}
 * 
 * @author Alan Buttars
 *
 */
public class ExtractFileAsStubSevenZImplTest {

	private File archive;
	private ExtractFileAsStubSevenZImpl stub;

	@Before
	public void setup() throws IOException {
		archive = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ExtractFileAsStubSevenZImpl(archive));
	}

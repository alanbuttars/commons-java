...
/**
 * Test class for {@link ArchiveFileAsStubCpioImpl}.
 * 
 * @author Alan Buttars
 *
 */
public class ArchiveFileAsStubCpioImplTest {

	private File directory;
	private File destination;
	private ArchiveFileAsStubCpioImpl stub;

	@Before
	public void setup() throws IOException {
		directory = Files.createTempDirectory(getClass().getName()).toFile();
		destination = File.createTempFile(getClass().getName(), ".tmp");
		stub = spy(new ArchiveFileAsStubCpioImpl(directory));
	}

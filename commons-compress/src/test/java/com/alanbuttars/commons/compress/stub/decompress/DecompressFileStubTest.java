...
/**
 * Test class for {@link DeompressFileStub}.
 * 
 * @author Alan Buttars
 *
 */
public class DecompressFileStubTest {
	...
	public void testConstructor() {
		DecompressFileStub stub = new DecompressFileStub(source);
	...
	public void testWithNullFileType() {
		try {
			new DecompressFileStub(source).with(null, compressionFunction);
			fail();
		}
	...
	public void testWithEmptyFileType() {
		try {
			new DecompressFileStub(source).with("", compressionFunction);
			fail();
		}
		catch (IllegalArgumentException e) {
	...
	public void testWithNullCompressionFunction() {
		try {
			new DecompressFileStub(source).with("blah", null);
			fail();
		}
		catch (IllegalArgumentException e) {

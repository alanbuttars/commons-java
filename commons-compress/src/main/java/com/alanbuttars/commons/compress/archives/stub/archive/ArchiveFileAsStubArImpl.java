...
/**
 * Extension of {@link ArchiveFileAsStub} for {@link Archives#AR} archives.
 * 
 * @author Alan Buttars
 *
 */
class ArchiveFileAsStubArImpl extends ArchiveFileAsStub {

	private int longFileMode;

	ArchiveFileAsStubArImpl(File directory) {
		super(directory, AR);
	}

	public ArchiveFileAsStubArImpl withLongFileMode(int longFileMode) {

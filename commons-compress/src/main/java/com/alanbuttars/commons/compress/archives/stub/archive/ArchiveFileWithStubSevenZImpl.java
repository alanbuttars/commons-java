...
/**
 * Extension of {@link ArchiveFileWithStub} for {@link Archives#SEVENZ} archives.
 * 
 * @author Alan Buttars
 *
 */
class ArchiveFileWithStubSevenZImpl extends ArchiveFileWithStub {

	private Iterable<? extends SevenZMethodConfiguration> contentMethods;

	ArchiveFileWithStubSevenZImpl(File source) {
		super(source, SEVENZ);
	}

	public ArchiveFileWithStubSevenZImpl withContentMethods(Iterable<? extends SevenZMethodConfiguration> contentMethods) {

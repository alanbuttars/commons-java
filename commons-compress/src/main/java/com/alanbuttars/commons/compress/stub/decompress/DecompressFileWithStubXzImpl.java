...
/**
 * Extension of {@link DecompressFileWithStub} for {@link CompressedFiles#XZ} files.
 * 
 * @author Alan Buttars
 *
 */
public class DecompressFileWithStubXzImpl extends DecompressFileWithStub {

	private boolean decompressConcatenated;

	DecompressFileWithStubXzImpl(File source) {
		super(source, XZ);
		this.decompressConcatenated = false;
	}

	public DecompressFileWithStubXzImpl andDecompressConcatenated(boolean decompressConcatenated) {

...
/**
 * Extension of {@link ExtractFileAsStub} for {@link Archives#ARJ } archives.
 * 
 * @author Alan Buttars
 *
 */
class ExtractFileAsStubArjImpl extends ExtractFileAsStub {

	private String encoding;

	ExtractFileAsStubArjImpl(File archive) {
		super(archive, Archives.ARJ);
	}

	public ExtractFileAsStubArjImpl withEncoding(String encoding) {

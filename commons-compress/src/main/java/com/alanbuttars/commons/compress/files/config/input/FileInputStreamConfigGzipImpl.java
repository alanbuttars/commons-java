...
/**
 * Extension of {@link FileInputStreamConfig} used for {@link Files#GZIP} files.
 * 
 * @author Alan Buttars
 *
 */
public class FileInputStreamConfigGzipImpl extends FileInputStreamConfig {

	private boolean decompressConcatenated;

	public FileInputStreamConfigGzipImpl(InputStream inputStream) {
		super(inputStream);

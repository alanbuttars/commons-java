...
/**
 * Extension of {@link ExtractFileWithStub} for {@link Archives#DUMP} archives.
 * 
 * @author Alan Buttars
 *
 */
class ExtractFileWithStubDumpImpl extends ExtractFileWithStub {

	private String encoding;

	ExtractFileWithStubDumpImpl(File source) {
		super(source, Archives.DUMP);
	}

	public ExtractFileWithStubDumpImpl withEncoding(String encoding) {

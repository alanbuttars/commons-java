 ...
 *
 */
public class CompressDirectoryWithStubJarImpl extends CompressDirectoryWithStub {
	...
	CompressDirectoryWithStubJarImpl(File source) {
		super(source, JAR);
		this.comment = "";
		this.encoding = "UTF8";
	 ...
	 * {@link JarArchiveOutputStream#setComment(String)}.
	 */
	public CompressDirectoryWithStubJarImpl andComment(String comment) {
	 ...
	 */
	public CompressDirectoryWithStubJarImpl andEncoding(String encoding) {
	 ...
	 * By default, it is set to <code>false</code>. See {@link JarArchiveOutputStream#setFallbackToUTF8(boolean)}.
	 */
	public CompressDirectoryWithStubJarImpl andFallbackToUTF8(boolean fallbackToUTF8) {
	 ...
	 * {@link ZipArchiveOutputStream#DEFAULT_COMPRESSION}. See {@link JarArchiveOutputStream#setLevel(int)}.
	 */
	public CompressDirectoryWithStubJarImpl andLevel(int level) {
		this.level = level;
		return this;
	}
	 ...
	 * {@link JarArchiveOutputStream#setMethod(int)}.
	 */
	public CompressDirectoryWithStubJarImpl andMethod(int method) {
		this.method = method;
		return this;
	}
	 ...
	 * {@link JarArchiveOutputStream#setCreateUnicodeExtraFields(UnicodeExtraFieldPolicy)}.
	 */
	public CompressDirectoryWithStubJarImpl andUnicodeExtraFieldPolicy(UnicodeExtraFieldPolicy unicodeExtraFieldPolicy) {
	 ...
	 * default, it is set to <code>true</code>. See {@link JarArchiveOutputStream#setUseLanguageEncodingFlag(boolean)}.
	 */
	public CompressDirectoryWithStubJarImpl andUseLanguageEncoding(boolean useLanguageEncoding) {
	 ...
	 * {@link JarArchiveOutputStream#setUseZip64(Zip64Mode)}.
	 */
	public CompressDirectoryWithStubJarImpl andZip64Mode(Zip64Mode zip64Mode) {
	...
	protected ArchiveOutputStream createArchiveOutputStream(File file, //
		...
		JarArchiveOutputStream archiveOutputStream = new JarArchiveOutputStream(fileOutputStream, encoding);

...
/**
 * Extension of {@link CompressorOutputStreamConfig} used for {@link CompressedFiles#DEFLATE} files.
 * 
 * @author Alan Buttars
 *
 */
public class CompressedFileOutputStreamConfigDeflateImpl extends CompressedFileOutputStreamConfig {

	private DeflateParameters parameters;

	public CompressedFileOutputStreamConfigDeflateImpl(OutputStream outputStream) {
		super(outputStream);

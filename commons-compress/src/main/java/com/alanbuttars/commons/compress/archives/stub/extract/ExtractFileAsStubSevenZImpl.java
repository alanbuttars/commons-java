...
/**
 * Extension of {@link ExtractFileAsStub} for {@link Archives#SEVENZ} archives.
 * 
 * @author Alan Buttars
 *
 */
class ExtractFileAsStubSevenZImpl extends ExtractFileAsStub {

	private byte[] password;

	ExtractFileAsStubSevenZImpl(File archive) {
		super(archive, SEVENZ);
	}

	public ExtractFileAsStubSevenZImpl withPassword(byte[] password) {

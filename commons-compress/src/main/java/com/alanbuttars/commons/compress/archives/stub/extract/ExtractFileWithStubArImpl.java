...
/**
 * Extension of {@link ExtractFileWithStub} for {@link Archives#AR} archives.
 * 
 * @author Alan Buttars
 *
 */
class ExtractFileWithStubArImpl extends ExtractFileWithStub {

	ExtractFileWithStubArImpl(File source) {
		super(source, Archives.AR);
	}

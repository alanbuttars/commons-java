...
/**
 * Extension of {@link ArchiveFileAsStub} for {@link Archives#CPIO} archives.
 * 
 * @author Alan Buttars
 *
 */
class ArchiveFileAsStubCpioImpl extends ArchiveFileAsStub {

	private short format;
	private int blockSize;
	private String encoding;

	ArchiveFileAsStubCpioImpl(File directory) {
		super(directory, CPIO);
	}

	public ArchiveFileAsStubCpioImpl withFormat(short format) {
		this.format = format;
		return this;
	}

	public ArchiveFileAsStubCpioImpl withBlockSize(int blockSize) {
		this.blockSize = blockSize;
		return this;
	}

	public ArchiveFileAsStubCpioImpl withEncoding(String encoding) {

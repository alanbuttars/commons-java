...
/**
 * Extension of {@link ExtractFileAsStub} for {@link Archives#ZIP} archives.
 * 
 * @author Alan Buttars
 *
 */
class ExtractFileAsStubZipImpl extends ExtractFileAsStub {

	private String encoding;
	private Boolean useUnicodeExtraFields;
	private Boolean allowStoredEntriesWithDataDescriptor;

	ExtractFileAsStubZipImpl(File archive) {
		super(archive, Archives.ZIP);
	}

	public ExtractFileAsStubZipImpl withEncoding(String encoding) {
		this.encoding = encoding;
		return this;
	}

	public ExtractFileAsStubZipImpl withUnicodeExtraFields(boolean useUnicodeExtraFields) {
		this.useUnicodeExtraFields = useUnicodeExtraFields;
		return this;
	}

	public ExtractFileAsStubZipImpl withStoredEntriesWithDataDescriptor(boolean allowStoredEntriesWithDataDescriptor) {

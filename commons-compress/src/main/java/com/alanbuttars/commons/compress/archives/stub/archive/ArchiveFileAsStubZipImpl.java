 ...
 *
 */
class ArchiveFileAsStubZipImpl extends ArchiveFileAsStub {
	...
	ArchiveFileAsStubZipImpl(File directory) {
		super(directory, ZIP);
	}

	public ArchiveFileAsStubZipImpl withComment(String comment) {
		this.comment = comment;
		return this;
	}

	public ArchiveFileAsStubZipImpl withUnicodeExtraFieldPolicy(UnicodeExtraFieldPolicy unicodeExtraFieldPolicy) {
		this.unicodeExtraFieldPolicy = unicodeExtraFieldPolicy;
		return this;
	}

	public ArchiveFileAsStubZipImpl withEncoding(String encoding) {
		this.encoding = encoding;
		return this;
	}

	public ArchiveFileAsStubZipImpl fallbackToUTF8(boolean fallbackToUTF8) {
		this.fallbackToUTF8 = fallbackToUTF8;
		return this;
	}

	public ArchiveFileAsStubZipImpl withLevel(int level) {
		this.level = level;
		return this;
	}

	public ArchiveFileAsStubZipImpl withMethod(int method) {
		this.method = method;
		return this;
	}

	public ArchiveFileAsStubZipImpl useLanguageEncoding(boolean useLanguageEncoding) {
		this.useLanguageEncoding = useLanguageEncoding;
		return this;
	}

	public ArchiveFileAsStubZipImpl withZip64Mode(Zip64Mode zip64Mode) {

...
/**
 * Extension of {@link ExtractFileWithStub} for {@link Archives#JAR} archives.
 * 
 * @author Alan Buttars
 *
 */
class ExtractFileWithStubJarImpl extends ExtractFileWithStub {

	private String encoding;

	ExtractFileWithStubJarImpl(File source) {
		super(source, Archives.JAR);
	}

	public ExtractFileWithStubJarImpl withEncoding(String encoding) {

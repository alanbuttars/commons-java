...
/**
 * Extension of {@link DecompressFileWithStub} for {@link CompressedFiles#BZIP2} files.
 * 
 * @author Alan Buttars
 *
 */
public class DecompressFileWithStubBzipImpl extends DecompressFileWithStub {

	private boolean decompressConcatenated;

	DecompressFileWithStubBzipImpl(File source) {
		super(source, BZIP2);
		this.decompressConcatenated = false;
	}

	public DecompressFileWithStubBzipImpl andDecompressConcatenated(boolean decompressConcatenated) {

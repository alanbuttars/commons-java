...
/**
 * Extension of {@link CompressedFileInputStreamConfig} used for {@link CompressedFiles#SNAPPY} files.
 * 
 * @author Alan Buttars
 *
 */
public class CompressedFileInputStreamConfigSnappyImpl extends CompressedFileInputStreamConfig {
	...
	public CompressedFileInputStreamConfigSnappyImpl(InputStream inputStream) {
		super(inputStream);

 ...
 *
 */
class ArchiveFileWithStubJarImpl extends ArchiveFileWithStub {
	...
	ArchiveFileWithStubJarImpl(File source) {
		super(source, JAR);
	}

	public ArchiveFileWithStubJarImpl withEncoding(String encoding) {
		this.encoding = encoding;
		return this;
	}

	public ArchiveFileWithStubJarImpl withComment(String comment) {
		this.comment = comment;
		return this;
	}

	public ArchiveFileWithStubJarImpl withUnicodeExtraFieldPolicy(UnicodeExtraFieldPolicy unicodeExtraFieldPolicy) {
		this.unicodeExtraFieldPolicy = unicodeExtraFieldPolicy;
		return this;
	}

	public ArchiveFileWithStubJarImpl fallbackToUTF8(boolean fallbackToUTF8) {
		this.fallbackToUTF8 = fallbackToUTF8;
		return this;
	}

	public ArchiveFileWithStubJarImpl withLevel(int level) {
		this.level = level;
		return this;
	}

	public ArchiveFileWithStubJarImpl withMethod(int method) {
		this.method = method;
		return this;
	}

	public ArchiveFileWithStubJarImpl useLanguageEncoding(boolean useLanguageEncoding) {
		this.useLanguageEncoding = useLanguageEncoding;
		return this;
	}

	public ArchiveFileWithStubJarImpl withZip64Mode(Zip64Mode zip64Mode) {

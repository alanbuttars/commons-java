...
/**
 * Extension of {@link ExtractFileWithStub} for {@link Archives#CPIO} archives.
 * 
 * @author Alan Buttars
 *
 */
class ExtractFileWithStubCpioImpl extends ExtractFileWithStub {

	private int blockSize;
	private String encoding;

	ExtractFileWithStubCpioImpl(File source) {
		super(source, Archives.CPIO);
	}

	public ExtractFileWithStubCpioImpl withBlockSize(int blockSize) {
		this.blockSize = blockSize;
		return this;
	}

	public ExtractFileWithStubCpioImpl withEncoding(String encoding) {

...
/**
 * Extension of {@link DecompressFileWithStub} for {@link CompressedFiles#LZMA} files.
 * 
 * @author Alan Buttars
 *
 */
public class DecompressFileWithStubLzmaImpl extends DecompressFileWithStub {

	DecompressFileWithStubLzmaImpl(File source) {
		super(source, LZMA);
	}

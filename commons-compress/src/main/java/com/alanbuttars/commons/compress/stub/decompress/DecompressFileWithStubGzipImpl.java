...
/**
 * Extension of {@link DecompressFileWithStub} for {@link CompressedFiles#GZIP} files.
 * 
 * @author Alan Buttars
 *
 */
public class DecompressFileWithStubGzipImpl extends DecompressFileWithStub {

	private boolean decompressConcatenated;

	DecompressFileWithStubGzipImpl(File source) {
		super(source, GZIP);
		this.decompressConcatenated = false;
	}

	public DecompressFileWithStubGzipImpl andDecompressConcatenated(boolean decompressConcatenated) {

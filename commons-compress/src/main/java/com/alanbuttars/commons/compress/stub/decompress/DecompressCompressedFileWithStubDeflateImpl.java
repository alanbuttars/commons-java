...
/**
 * Extension of {@link DecompressCompressedFileWithStub} for {@link CompressedFiles#DEFLATE} files. For details on the
 * file format, see <a href="https://en.wikipedia.org/wiki/DEFLATE">https://en.wikipedia.org/wiki/DEFLATE</a>.
 * 
 * @author Alan Buttars
 *
 */
public class DecompressCompressedFileWithStubDeflateImpl extends DecompressCompressedFileWithStub {

	private DeflateParameters parameters;;

	DecompressCompressedFileWithStubDeflateImpl(File source) {
	 ...
	 */
	public DecompressCompressedFileWithStubDeflateImpl andParameters(DeflateParameters parameters) {

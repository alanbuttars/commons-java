...
/**
 * Extension of {@link ExtractFileWithStub} for {@link Archives#TAR} archives.
 * 
 * @author Alan Buttars
 *
 */
class ExtractFileWithStubTarImpl extends ExtractFileWithStub {

	private int blockSize;
	private int recordSize;
	private String encoding;

	ExtractFileWithStubTarImpl(File source) {
		super(source, Archives.TAR);
	}

	public ExtractFileWithStubTarImpl withBlockSize(int blockSize) {
		this.blockSize = blockSize;
		return this;
	}

	public ExtractFileWithStubTarImpl withRecordSize(int recordSize) {
		this.recordSize = recordSize;
		return this;
	}

	public ExtractFileWithStubTarImpl withEncoding(String encoding) {
